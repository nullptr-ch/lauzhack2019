import Microdemocracy from 'assets/microdemocracy'
import { Notify } from 'quasar'

export const createContractInstance = async ({ commit }) => {
  try {
    commit('SET_CONTRACT_BIN', Microdemocracy.bin)
    commit('SET_CONTRACT_ABI', Microdemocracy.abi)
...
export const deployContract = async ({
  ...
  await commit('SET_CONTRACT_BIN', Microdemocracy.bin)
  await commit('SET_CONTRACT_ABI', Microdemocracy.abi)
